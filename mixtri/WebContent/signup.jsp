			...
			<div class="djSignUp">
				<div class="row">
					...
					<div id="aboutus" class="col-lg-6 col-md-6 col-sm-6">
						<div class="aboutus">
							<h2>Get On the Groove Anywhere, Anytime</h2>
							<br> <br>
				...
				<div class="row">
					...
					<div id="aboutus" class="col-lg-6 col-md-6 col-sm-6">
						<div class="signUpIcons">
							...
							<ul>
								<li class="liveIcons"><span style="font-size: xx-large;"
									class="fa fa-volume-up"></span>
									<h4>Live Audio</h4></li>
								<li class="liveIcons"><span style="font-size: xx-large;"
									class="fa fa-video-camera"></span>
									<h4>Live Video</h4></li>
							</ul>
						</div>
						<div class="signUpIcons">
			...
			<div class="whyMixtri" style="margin-bottom: 30px;">
				...
				<div>
					<div class="row">
						<div class="features">
							<div class="col-lg-4 col-md-4 col-sm-4">
								<span style="font-size: xx-large;" class="fa fa-dollar"></span>
								Fans gets you business
							</div>

							<div class="col-lg-4 col-md-4 col-sm-4">
								<span style="font-size: xx-large;" class="fa fa-mobile"></span>
								iOS/Android
							</div>

							<div class="col-lg-4 col-md-4 col-sm-4">
								<span style="font-size: xx-large;" class="fa fa-database"></span>
								Storage space
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="features">
							<div class="col-lg-4 col-md-4 col-sm-4">
								<span style="font-size: xx-large;" class="fa fa-volume-up"></span>
								Free Unlimited Broadcasts
							</div>

							<div class="col-lg-4 col-md-4 col-sm-4">
								<span style="font-size: xx-large;" class="fa fa-video-camera"></span>
								Live Video
							</div>

							<div class="col-lg-4 col-md-4 col-sm-4">
								<span style="font-size: xx-large;" class="fa fa-file-image-o"></span>
								Brand Promotion
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="features">
							<div class="col-lg-4 col-md-4 col-sm-4">
								<span style="font-size: xx-large;" class="fa fa-play-circle"></span>
								Audio Recording
							</div>

							<div class="col-lg-4 col-md-4 col-sm-4">
								<span style="font-size: xx-large;" class="fa fa-desktop"></span>
								Party Version
							</div>

							<div class="col-lg-4 col-md-4 col-sm-4">
								<span style="font-size: xx-large;" class="fa fa-thumbs-o-up"></span>
								Social Connects
							</div>
						</div>
					</div>
