			...
			<div class="container">
				<div class="row">
					<div class="col-lg-6 col-md-6 col-sm-6">
						<h1>latest events</h1>
						<h5>list of upcoming and previous events</h5>
					</div>
					...
					<div class="row">
						...
						<div class="col-lg-4 col-md-4 col-sm-4">
							...
							<div class="djsignup">
								...
								<ul class="sitemap">
									<li><a href="#"><span class="fa fa-chevron-left">
												Now Live!</span></a></li>
									<li><a href="#"><span class="fa fa-smile-o">
												Most Popular </span></a></li>
									<li><a href="#"><span class="fa fa-heart"></span> My
											Djs </a></li>
								</ul>
						...
						<div class="col-lg-4 col-md-4 col-sm-4">
							<div class="genre-dropdown">
								<button class="btn btn-default dropdown-toggle" type="button"
									...
									Music Genres <span class="caret"></span>
								</button>
